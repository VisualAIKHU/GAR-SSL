...
from bbox_utils import clip_box, clamp_delta, apply_ops, denorm_xywh_to_xyxy
from evaluator import Evaluator
from data_utils import load_music_solo_gt
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="GAR - MUSIC Solo")
    parser.add_argument("--model_id",     type=str,   default="Qwen/Qwen2.5-Omni-7B")
    parser.add_argument("--frame_dir",    type=str,   default="/data/subin/MUSIC/solo/test/frames")
    parser.add_argument("--audio_dir",    type=str,   default="/data/subin/MUSIC/solo/test/audio")
    parser.add_argument("--gt_path",      type=str,   default="/data/subin/metadata/music_solo.json")
    parser.add_argument("--out_root",     type=str,   default="/data/subin/GAR_CVPR26/outputs/GAR_music_solo")
    ...
    gt_dict    = load_music_solo_gt(gt_path)
    ...
    for i, frame_file in enumerate(frame_files, 1):
        ...
        try:
            ...
            # ---------- 시각화/저장 ----------
            gt_box_xyxy = clip_box(denorm_xywh_to_xyxy(gt_dict[vid], W, H), W, H)
